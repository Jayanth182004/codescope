      ...
      <div className="auth-card" style={{ width: "100%", maxWidth: 400, position: "relative" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10, marginBottom: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, justifyContent: "center" }}>
            <Icons.logo />
            <span style={{ fontSize: 16, fontWeight: 700, color: T.text, letterSpacing: "-0.02em", fontFamily: T.sans }}>Coderitz</span>
          </div>
          
          {/* Back to landing link */}
          <button 
            onClick={() => {
              // Assuming landing page is running alongside or handled by routing trigger.
              // In this single-page router, we can trigger redirect or screen navigation
  ...
  return (
    ...
    >
      ...
      <div style={{ height: 52, display: "flex", alignItems: "center", padding: collapsed ? "0 16px" : "0 14px", borderBottom: `1px solid ${T.border}`, gap: 8, flexShrink: 0 }}>
        <Icons.logoSm />
        {!collapsed && (
          <span style={{ fontSize: 14, fontWeight: 500, color: T.text, letterSpacing: "-0.01em", fontFamily: T.sans, flex: 1 }}>Coderitz</span>
        )}
        {!collapsed && (
          <button
    ...
    <div style={{ position: "fixed", inset: 0, zIndex: 100, display: "flex" }}>
      ...
      <div style={{ position: "relative", width: 240, background: T.surface, borderRight: `1px solid ${T.border}`, display: "flex", flexDirection: "column", height: "100%", animation: "fadeUp 0.2s ease" }}>
        <div style={{ height: 52, display: "flex", alignItems: "center", padding: "0 14px", borderBottom: `1px solid ${T.border}`, gap: 8 }}>
          <Icons.logoSm />
          <span style={{ fontSize: 14, fontWeight: 500, color: T.text, letterSpacing: "-0.01em", fontFamily: T.sans }}>Coderitz</span>
