...
from app.schemas.dashboard import DashboardOverview, DashboardStats, ActivityLogOut
from app.schemas.project import ProjectOut
from app.schemas.envelope import APIEnvelope
from app.repositories.workspace_repository import WorkspaceRepository
from app.repositories.project_repository import ProjectRepository
from app.models.models import User, ActivityLog, Project, Favorite
...
def get_dashboard_overview(
    ...
    indexed_deps = total_repos * 187 # placeholder indexing count
    ...
    # 2. Recent Projects (sorted by creation date)
